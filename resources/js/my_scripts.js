...
function loadStatsPage() {
    ...
    var table, row_counter, buffwins, bufflosses; 
    ...
    bufflosses = 0;
  	...
  	for (row_counter = 2; row_counter < table.rows.length; row_counter += 1) {




  	  var buffscore = table.rows[row_counter].cells[2].innerHTML;
  	  var awayscore = table.rows[row_counter].cells[3].innerHTML;
...
function switchPlayers(playerNum) {
	...
	document.getElementById("avg_p_yards").innerHTML = (players[playerNum].pass_yards / players[playerNum].games_played).toFixed(1);
	document.getElementById("r_yards").innerHTML = players[playerNum].rushing_yards;
	document.getElementById("avg_r_yards").innerHTML = (players[playerNum].rushing_yards / players[playerNum].games_played).toFixed(1);
	document.getElementById("rec_yards").innerHTML = players[playerNum].receiving_yards;
	document.getElementById("avg_rec_yards").innerHTML = (players[playerNum].receiving_yards / players[playerNum].games_played).toFixed(1);
